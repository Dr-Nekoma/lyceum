...
INSERT INTO lyceum.character_position (name, e_mail, username, x_position, y_position, x_velocity, y_velocity, map_name, face_direction)
VALUES ('Huneric', 'mmagueta@example.com', 'mmagueta', 10, 20, 0, 0, 'CASTLE_HALL', 270),
       ('Gaiseric', 'mmagueta@example.com', 'mmagueta', 15, 15, 0, 0, 'CASTLE_HALL', 270),
       ('Legion', 'lambdu@example.com', 'lambdu', 15, 15, 0, 0, 'CASTLE_HALL', 270);
