...
CREATE TABLE lyceum."character"(
       ...
       "e-mail" TEXT NOT NULL CHECK ("e-mail" ~* '^[A-Za-z0-9.+%-]+@[A-Za-z0-9.-]+[.][A-Za-z]+$'),
       "username" VARCHAR(32) NOT NULL,
       FOREIGN KEY ("e-mail", "username") REFERENCES lyceum."user"("e-mail", "username"),
...
CREATE TABLE lyceum."character_stats"(
       ...
       FOREIGN KEY ("name", "username", "e-mail") REFERENCES lyceum."character"("name", "username", "e-mail"),
       PRIMARY KEY("name", "username", "e-mail")
);
...
CREATE TABLE lyceum."character_position"(
       ...
       PRIMARY KEY("name", "username", "e-mail", "map_name")
);
...
BEGIN
    INSERT INTO lyceum."character"("name", "e-mail", "username")
    VALUES (NEW."name", NEW."e-mail", NEW."username");

    INSERT INTO lyceum."character_stats"("name", "e-mail", "username", "constitution", "wisdom", "strength", "endurance", "intelligence", "faith")
    VALUES (NEW."name", NEW."e-mail", NEW."username", NEW."constitution", NEW."wisdom", NEW."strength", NEW."endurance", NEW."intelligence", NEW."faith");
...
-- INSERT INTO lyceum."user"("username", "e-mail", "password")
