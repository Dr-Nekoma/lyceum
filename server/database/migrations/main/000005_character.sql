...
CREATE TABLE IF NOT EXISTS character.stats (
    ...
    constitution SMALLINT NOT NULL CHECK (
        constitution > 0 AND constitution <= 150
    ),
...
CREATE TABLE IF NOT EXISTS character.position (
    ...
    face_direction SMALLINT NOT NULL CHECK (
