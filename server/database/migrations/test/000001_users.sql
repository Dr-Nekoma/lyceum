...
INSERT INTO character.position (
    name, email, username, x_position, y_position, map_name, face_direction
)
...
(
    'Vandal''s Prima',
    'ARMS',
    'A rugged sword of unknown origin, favored by the wild tribes of the West. Its hilt is adorned with a crude carving depicting a dragon''s defeat by a golden warrior. It is said to be a symbol of the tribes'' turbulent beginnings.'
),
(
    'Legate''s Pugio',
    'ARMS',
    'A dagger commonly used by the legionaries, produced in large numbers to obey the strict standards of the res militaris.'
),
(
...
(
    'Sussman''s Lispy Fez',
    'HEAD',
    'The magical headgear from a once great wizard.'
)
ON CONFLICT (name, kind)
DO NOTHING;

-- Insert into lyceum.character_equipment
INSERT INTO equipment.character (
    name, email, username, is_equiped, equipment_name, use, kind
)
VALUES (
    'Huneric',
    'mmagueta@example.com',
