...
in linkFarm name [
  ...
  {
    name = "1220dd8a15f18b1676720d355305839a31c507c1854a8d4cee08485946097ffd5878";
    path = fetchZigArtifact {
      name = "zerl";
      url = "https://github.com/dont-rely-on-nulls/zerl/archive/bf1f05abab8a87a220cc4bcbcdc4387e9de5c260.tar.gz";
      hash = "sha256-n2HeBMpf3H8EhJjJjCtp7HPtIgHcrSwFKPhOFSjzXqA=";
    };
  }
]